...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    // Get Avg Recipe Rating
    // Get Recipe Rating if present for the RecipeName,SourceName
    public Cursor getRatingsOfRecipe(String recipeName, String sourceName){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select * from "+RECIPE_RATING_TABLE_NAME+" where RECIPE_NAME ='"+recipeName
